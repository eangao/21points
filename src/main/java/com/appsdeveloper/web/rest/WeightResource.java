...
/**
 * REST controller for managing {@link com.appsdeveloper.domain.Weight}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WeightResource {
    ...
    public ResponseEntity<Weight> updateWeight(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, weight.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Weight> partialUpdateWeight(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, weight.getId().toString())
        );
    }
